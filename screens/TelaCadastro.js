...
import { ButtonGroup } from "../components/ButtonsModalidade";
            ...
            <View style={styles.containerMaior}>
                ...
                <View style={styles.containerMenor}>
                    ...
                    <View style={styles.containerInputETexto}>               
                        ...
                        <View style={styles.containerBotoes1}>
                            ...
                            <TouchableHighlight 
                                ...
                                underlayColor="white"
                                onPress={() => navigation.navigate('TelaAbertura')}>
                    ...
                    <View style={styles.container2Tela}>
                        ...
                        <ButtonGroup buttons={['Aluno', 'Tutor', 'Não sei']}/>
                        ...
                        <SafeAreaView style={styles.safearea}>
                            ...
                            <Modal
                                ...
                                <Categoria
                                    changeModalVisibilityCategoria={changeModalVisibilityDisciplina}
                                    setCategoria={setDisciplina}/>
                            </Modal>
                        </SafeAreaView>
                        ...
                        <SafeAreaView style={styles.safearea}>
                            ...
                            <Modal
                                ...
                                <SubCategoria
                                    changeModalVisibilitySubCategoria={changeModalVisibilityMateria}
                                    setSubCategoria={setMateria}/>
                            </Modal>
                        </SafeAreaView>
                        ...
                        <View style={styles.containerBotoes2}>
                            ...
                            <TouchableHighlight 
                                ...
                                onPress={() => [ cadastrarUsuarioFirestore(nome.trim(), uid, email.trim(),  categoria,
                                                chooseDataEscolaridade, chooseDataDisciplina,  chooseDataMateria),
