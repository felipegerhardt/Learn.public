...
import { collectionGroup, collection, doc, setDoc, getFirestore, getDoc, query, where, orderBy, limit, getDocs } from "firebase/firestore"; 
        ...
        .catch((error) => {
            ...
            if (errorCode === "auth/user-not-found"){
                ...
                Alert.alert(
                    ...
                    [   
                        { text: 'Cadastrar', onPress: () => navigation.navigate('TelaCadastro')},
            ...
            if (errorCode === "auth/invalid-email"){
                Alert.alert(
                    ...
                    [   
                        ...
                        { text: "Sim", onPress: () => navigation.navigate('TelaCadastro') }                    
                    ]
                );
            };
       ...
       // const nav = useNavigation();
        ...
        signOut(auth).then(() => {
            ...
            .then(() => {
                ...
                navigation.navigate('RotasAutenticacao')
