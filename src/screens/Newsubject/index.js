...
export default function Newsubject({ navigation }){
    ...
    const createTwoButtonAlert = () => {
            ...
            Alert.alert(
                ...
                [
                    ...
                    { text: "Finalizar", onPress: () => navigation.navigate('Progress') }
                ]
            );
                ...
                <SafeAreaView>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.containerBotao}>
                            <TouchableOpacity onPress={() => [navigation.navigate('Home'), clearInterval(timer), setTempo("00:00:00")]}//navigation.goBack() } 
